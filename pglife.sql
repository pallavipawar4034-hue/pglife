...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2026 at 02:54 PM
...
CREATE TABLE `properties` (
  ...
  `rating_clean` float(3,1) NOT NULL DEFAULT 0.0,
  `rating_food` float(3,1) NOT NULL DEFAULT 0.0,
  `rating_safety` float(3,1) NOT NULL DEFAULT 0.0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `testimonials` (`id`, `property_id`, `user_id`, `user_name`, `content`) VALUES
(1, 1, 0, 'Ashutosh Gowariker', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(2, 1, 0, 'Karan Johar', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(3, 2, 0, 'Zoya Akhtar', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(4, 2, 0, 'Farhan Akhtar', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(5, 2, 0, 'Anurag Kashyap', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(6, 3, 0, 'Mira Nair', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(7, 3, 0, 'Meghna Gulzar', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(8, 4, 0, 'Farah Khan', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(9, 5, 0, 'Rajkumar Hirani', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(10, 5, 0, 'Sanjay Leela Bhansali', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(11, 1, 1, '', 'The property is extremely well-maintained and clean. Highly recommended for students!');
...
(5, 'rahul.test@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Rahul Sharma', '9876543210', 'male', 'COEP Tech univercity'),
(6, 'rahul.test@gemail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Rahul Sharma', '9876543210', 'male', 'COEP Tech univercity'),
(7, 'pallavipawar2105@gmail.com', 'f5f730b3a07a2d3ade039a5a4f5e346b9ca7c5e0', 'Pallavi Pawar', '8010850441', 'female', 'COEP Tech univercity');
...
--
ALTER TABLE `interested_users_properties`
  ADD CONSTRAINT `interested_users_properties_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `interested_users_properties_ibfk_2` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `properties`
--
ALTER TABLE `properties`
  ADD CONSTRAINT `properties_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `testimonials`
  ADD CONSTRAINT `testimonials_ibfk_1` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE;
COMMIT;
